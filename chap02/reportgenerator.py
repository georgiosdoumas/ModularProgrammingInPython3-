...
def generate_inventory_report():
    product_names = {}
    for product_code, pname, desired_number in datastorage.products():
        product_names[product_code] = pname
    location_names = {}
    for location_code, lname in datastorage.locations():
        location_names[location_code] = lname
    grouped_items = {}
