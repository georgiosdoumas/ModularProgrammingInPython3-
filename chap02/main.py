...
def main():
    datastorage.init()
    datastorage.set_products([("SKU123", "4 mm flat-head wood screw", 50),
    ...
    datastorage.set_locations([("S1A1", "Shelf 1, Aisle 1"),
            ...
            if product != None:
                ...
                if location != None:
                    if not datastorage.remove_item(product, location):
                        userinterface.show_error("There is no product with {} code at location {}!".format(product, location))
